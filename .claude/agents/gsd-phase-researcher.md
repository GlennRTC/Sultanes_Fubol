...
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/thinking-models-research.md
...
```bash
node "D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
