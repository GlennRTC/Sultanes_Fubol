...
Reference full template: `D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/templates/state.md`.
