...
<required_reading>
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = D:/sultanes_fubol/Sultanes_Fubol/.claude
                  → checks D:/sultanes_fubol/Sultanes_Fubol/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core
                  → writes to D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/hooks/
...
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/thinking-models-debug.md
...
- Read @D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/common-bug-patterns.md
