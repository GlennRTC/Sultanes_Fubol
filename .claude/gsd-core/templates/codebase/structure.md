...
- Usage: Reference from command with `@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/workflows/{name}.md`
...
**gsd-core/**
- Purpose: Resources installed to D:/sultanes_fubol/Sultanes_Fubol/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/sultanes_fubol/Sultanes_Fubol/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
