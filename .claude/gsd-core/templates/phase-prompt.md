...
<!-- For checkpoint task examples and patterns, see @D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/checkpoints.md -->
...
See `D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/workflows/verify-phase.md` for verification logic.
