...
INSTALL_JS_GLOBAL="D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
