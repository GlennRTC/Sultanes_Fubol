...
<required_reading>
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/domain-probes.md
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/gate-prompts.md
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
