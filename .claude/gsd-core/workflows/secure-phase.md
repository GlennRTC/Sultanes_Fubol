...
```
Agent(
  prompt="Read D:/sultanes_fubol/Sultanes_Fubol/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/templates/SECURITY.md`
