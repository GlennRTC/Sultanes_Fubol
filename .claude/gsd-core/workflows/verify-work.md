...
<template>
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/workflows/transition.md`.
...
- Follow @D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/workflows/diagnose-issues.md
