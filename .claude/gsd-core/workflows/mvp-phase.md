...
<required_reading>
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/user-story-template.md
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/spidr-splitting.md
@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/user-story-template.md`:
...
Run the SPIDR rules from `@D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/references/spidr-splitting.md`. Briefly:
