...
```markdown
Read D:/sultanes_fubol/Sultanes_Fubol/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/sultanes_fubol/Sultanes_Fubol/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/sultanes_fubol/Sultanes_Fubol/.claude/agents/gsd-ui-checker.md for instructions.
